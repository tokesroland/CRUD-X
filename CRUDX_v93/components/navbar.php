...
<style>
    ...
    .wh-tooltip-box:hover .wh-tooltip {
        visibility: visible;
        opacity: 1;
...
<header style="user-select: none;" class="topbar">
    ...
    <nav class="nav" id="mainNav">
        ...
        <a class="nav-link <?= ($activePage == 'products.php' || $activePage == 'products') ? 'active' : '' ?>" href="products">Termékek</a>
    ...
    <div class="user-box" id="userBox">
        ...
        <a href="components/logout.php" class="btn btn-outline"
            style="padding: 6px 12px; font-size: 0.8rem; color:white; border-color:rgba(255,255,255,0.2);">Kijelentkezés</a>
    </div>
</header>
