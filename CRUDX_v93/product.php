...
<head>
    ...
    <style>
        ...
        .skeleton { background-color: #e2e8f0; color: transparent !important; border-radius: 4px; animation: pulse 2s infinite; user-select: none; }
...
<body>
    ...
    <main class="container">
        ...
        <div id="error-container" class="hidden" style="text-align:center; padding: 40px; color: #ef4444;">
            ...
            <a href="<?= $BASE_URL ?>products.php" class="btn btn-outline">Vissza a listához</a>
        </div>
        ...
        <section class="card" id="main-content">
            <div class="card-header">
                ...
                <a href="<?= $BASE_URL ?>products.php" class="btn btn-outline btn-small">Vissza a listához</a>
            </div>
            ...
            <div style="display:flex; gap:32px; flex-wrap:wrap; margin-bottom: 20px;">
                ...
                <div style="flex: 1; min-width: 300px;">
                    <div style="display: grid; grid-template-columns: auto 1fr; gap: 10px 20px; align-items: center;">
                        ...
                        <span class="muted">Cikkszám:</span> <strong id="p-item-number" class="skeleton">-------</strong>
                        <span class="muted">Kategória:</span> <strong id="p-category" class="skeleton">--------</strong>
                        <span class="muted">Státusz:</span> <div id="p-status" class="skeleton">-----</div>
                        <span class="muted">Rögzítve:</span> <small id="p-created" class="skeleton">----.--.--</small>
                        <span class="muted">Utolsó mozgás:</span> <small id="p-updated" class="skeleton">----.--.--</small>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        async function loadProductData() {
            try {
                // Itt állítjuk össze a pontos URL-t
                // Mivel a BASE_URL-ben már benne van a '/' a végén (/CRUDX_v93/), nem kell mégegyet tenni.
                const response = await fetch(`${BASE_URL}api/v1/product_details.php?id=${PRODUCT_ID}`);
